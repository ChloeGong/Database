...
create index country on country(country_name);

create index journey on journey(nbooked);
--drop index journey;
--create index place on place(place_name);
create index vehicle on vehicle(capacity);
--drop index vehicle;
